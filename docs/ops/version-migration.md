...
A **1.21.1 down-port** was the obvious candidate for more reach afterwards, and it happened:
decided in #53, built in #54, and now a supported line on branch `v1.21.1`. This document stays
the 1.20.4 → 26.2 plan; which lines are supported is [`multiloader.md`](multiloader.md).
