...
| Matrix | [matrix.md](matrix.md) | `MAT` | The 7 woods × 3 metals completeness rules |
...
| [MAT-03](matrix.md#mat-03-metal-scoped-log-tags-list-all-seven-woods) | Metal-scoped log tags list all seven woods | done | — |
