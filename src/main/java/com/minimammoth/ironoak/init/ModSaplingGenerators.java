...
public class ModSaplingGenerators {
    ...
    public static final SaplingGenerator COPPER_JUNGLE = generator("copper_jungle", ModConfiguredFeatures.COPPER_JUNGLE_TREE);
    public static final SaplingGenerator GOLD_JUNGLE = generator("gold_jungle", ModConfiguredFeatures.GOLD_JUNGLE_TREE);
    public static final SaplingGenerator IRON_JUNGLE = generator("iron_jungle", ModConfiguredFeatures.IRON_JUNGLE_TREE);

    public static final SaplingGenerator COPPER_DARK_OAK = generator("copper_dark_oak", ModConfiguredFeatures.COPPER_DARK_OAK_TREE);
    public static final SaplingGenerator GOLD_DARK_OAK = generator("gold_dark_oak", ModConfiguredFeatures.GOLD_DARK_OAK_TREE);
    public static final SaplingGenerator IRON_DARK_OAK = generator("iron_dark_oak", ModConfiguredFeatures.IRON_DARK_OAK_TREE);

    public static final SaplingGenerator COPPER_SPRUCE = generator("copper_spruce", ModConfiguredFeatures.COPPER_SPRUCE_TREE);
    public static final SaplingGenerator GOLD_SPRUCE = generator("gold_spruce", ModConfiguredFeatures.GOLD_SPRUCE_TREE);
    public static final SaplingGenerator IRON_SPRUCE = generator("iron_spruce", ModConfiguredFeatures.IRON_SPRUCE_TREE);
