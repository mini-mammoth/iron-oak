...
public class SeparatorRenderer implements BlockEntityRenderer<SeparatorEntity> {
    private BlockEntityRendererFactory.Context context;

    public SeparatorRenderer(BlockEntityRendererFactory.Context context) {
        this.context = context;
    }

    @Override
    public void render(SeparatorEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
