...
public class ModRecipes {
    ...
    static {
        ...
        BURNING_RECIPE_SERIALIZER = Registry.register(BuiltInRegistries.RECIPE_SERIALIZER,
                ResourceLocation.fromNamespaceAndPath(MOD_ID, BurningRecipe.KEY),
                new SimpleCookingSerializer<>(BurningRecipe::new, DEFAULT_COOKING_TIME));
        ...
        WASHING_RECIPE_SERIALIZER = Registry.register(BuiltInRegistries.RECIPE_SERIALIZER,
                ResourceLocation.fromNamespaceAndPath(MOD_ID, WashingRecipe.KEY),
                new SimpleCookingSerializer<>(WashingRecipe::new, DEFAULT_COOKING_TIME));
    }

    private static <T extends AbstractCookingRecipe> RecipeType<T> registerType(String key) {
        return Registry.register(BuiltInRegistries.RECIPE_TYPE, ResourceLocation.fromNamespaceAndPath(MOD_ID, key), new RecipeType<T>() {
            @Override
